...
import com.kienht.bubblepicker.rendering.BubbleShader.A_POSITION
import com.kienht.bubblepicker.rendering.BubbleShader.A_UV
import com.kienht.bubblepicker.rendering.BubbleShader.U_BACKGROUND
import com.kienht.bubblepicker.rendering.BubbleShader.fragmentShader
import com.kienht.bubblepicker.rendering.BubbleShader.vertexShader
...
class PickerRenderer(val glView: View) : GLSurfaceView.Renderer {
    ...
    private var initializationListener: OnReadyForInitializationListener? = null
...
//        initialize()
    ...
    fun setInitializationListener(listener: OnReadyForInitializationListener) {
        Log.i("TAG", "setting initialization listener in picker renderer")
